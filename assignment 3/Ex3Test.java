...
class Ex3Test {
    ...
    public void testValidHeight() {
        ...
        assertTrue(Ex3.hasValidHeightHelp(root));
    }
    ...
    public void testInvalidHeight() {
        ...
        assertFalse(Ex3.hasValidHeightHelp(root));
    }
    ...
    public void testValidHeight3() {
        ...
        assertFalse(Ex3.hasValidHeightHelp(roo3));
    }
...
//        roo.right.left.right = new Node(24, BLACK);
        ...
        assertTrue(Ex3.hasValidHeightHelp(roo));
    }
    ...
    public void testValidHeight5() {
        ...
        assertTrue(Ex3.hasValidHeightHelp(root4));
    }
    ...
    public void testValidHeight6() {
        ...
        assertTrue(Ex3.hasValidHeightHelp(root5));
    ...
    void testValidHeight7() {
        ...
        assertFalse(Ex3.hasValidHeightHelp(root7));
    }
    ...
    void testValidHeight8() {
        ...
        assertTrue(Ex3.hasValidHeightHelp(root8));
//        assertTrue(SandBoxEx3.isBalanced(root8));
    ...
    void testValidHeight9() {
        ...
        assertFalse(Ex3.hasValidHeightHelp(root8)); // supposed to be true and not false
//        assertFalse(SandBoxEx3.isBalanced(root8));
    ...
    void testValidHeight10() {
        ...
        assertFalse(Ex3.hasValidHeightHelp(root10)); // supposed to be true and not false
//        assertFalse(SandBoxEx3.isBalanced(root10));
    ...
    void testValidHeight11() {
        ...
        assertTrue(Ex3.hasValidHeightHelp(root11)); // supposed to be true and not false
    }
}
