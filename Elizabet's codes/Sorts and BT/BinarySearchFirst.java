...
public class BinarySearchFirst {
	...
	public static void main(String[] args) {
		int arr[] = {1, 3, 5, 6, 7};
		System.out.print(binarySearchInducion(arr,1)+", ");//0
		System.out.print(binarySearchInducion(arr,2)+", ");//-1
		System.out.print(binarySearchInducion(arr,3)+", ");//1
		System.out.print(binarySearchInducion(arr,4)+", ");//-1
		System.out.print(binarySearchInducion(arr,5)+", ");//2
		System.out.print(binarySearchInducion(arr,6)+", ");//3
		System.out.println(binarySearchInducion(arr,7)+", ");//4
		System.out.println(binarySearchInducion(arr,8)+", ");//-1
